...
function Denoise() {
  ...
  const [step, setStep] = useState(2); // Set initial step to "Human Extracted"
          ...
          <div className="mt-4 flex justify-center items-center font-roboto ">
            ...
            <div className="ml-auto ">
             ...
             <button className=" gap-3 h-[44px] flex   bg-orange-500 hover:bg-orange-600 text-white font-roboto py-2 px-4 ">
               <span className="mt-1"> Transcription</span> <FaRegArrowAltCircleRight size={20} className="mt-1" />
              </button>
             </Link>
            </div>
          </div>
